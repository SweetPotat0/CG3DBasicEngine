...
//		materials[shapes[pickedShape]->GetMaterial()]->Bind(textures);
	...
	if (shaderIndx == 0)
        ...
        s->SetUniform1f("fxStart",-4.0);
        s->SetUniform1f("fxEnd",4.0);
        s->SetUniform1f("fyStart",-4.0);
        s->SetUniform1f("fyEnd",4.0);
        s->SetUniform1f("scrnXWidth",800.0);
        s->SetUniform1f("scrnXHeight",800.0);
        s->SetUniform2f("root1",roots[0].real(),roots[0].imag());
        s->SetUniform3f("color1",1,0,0);
        s->SetUniform2f("root2",roots[1].real(),roots[1].imag());
        s->SetUniform3f("color2",0,1,0);
        s->SetUniform2f("root3",roots[2].real(),roots[2].imag());
        s->SetUniform3f("color3",0,0,1);
